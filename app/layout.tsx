...
// Next theme allows you to switch from light mode to dark mode <-- user interaction / needs the client to exist.
        ...
        <ThemeProvider attribute='class' defaultTheme='dark'>
          <main className="flex min-h-screen flex-col items-center p-24">
            <div className="z-10 w-full max-w-6xl items-center justify-between font-mono text-sm lg:flex">
              <Link href="/"><h2 className='text-3xl text-bold'>PokemonFinder.</h2></Link>
            </div>
            {children}
          </main>
        </ThemeProvider>
